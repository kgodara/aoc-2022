...
defmodule Diffusion do
  ...
  def calc_bbox_empty(coord_set) do
    ...
    {{min_r, max_r}, {min_c, max_c}} =
      ...
      then(fn coord_list ->
        {
          Enum.min_max_by(coord_list, fn {r,_} -> r end) |> then(fn {{min_r,_},{max_r,_}} -> {min_r, max_r} end),
          Enum.min_max_by(coord_list, fn {_,c} -> c end) |> then(fn {{_,min_c},{_,max_c}} -> {min_c, max_c} end),
        }
      end)
