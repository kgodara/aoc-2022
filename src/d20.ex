...
defmodule Grove do
  ...
  def mix(zero_dists, iter_num) do
    ...
    zero_dists = List.insert_at(zero_dists |> List.delete_at(c_num_idx), new_idx_pos, {c_num, orig_num_idx})
...
defmodule Main do
  def main() do
    ...
    IO.inspect(res_p1, label: "res_p1")
    IO.inspect(res_p2, label: "res_p2")
