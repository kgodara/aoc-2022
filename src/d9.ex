...
[{_, tail_pos1}, {_, tail_pos2}] =
  Enum.map(
    [2, 10],
    fn n ->
      Enum.reduce(parsed_move_cmds, {List.duplicate(origin, n), pos_set}, &Rope.exec_move(&1, &2))
    end
  )
